...
export default function EditJobModal({ isOpen, onClose, onJobUpdated, job }: EditJobModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Network error updating job")
    } finally {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 className="text-2xl font-bold text-[#2B2D42]">Edit Job</h2>
            <p className="text-[#2B2D42]/70 mt-1">Update your job posting details</p>
          </div>
